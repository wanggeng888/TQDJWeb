...
<body>
	<div class="container" ng-controller="tltdtable">
		<div class="text-right top-button-box">
			<a href="tltd.jsp?type=tltd&fun=1" class="btn btn-primary">录入</a>
		...
		<table class="table table-hover paging-box listtable">
			...
			<tr ng-repeat="news in newses">
				...
				<td class="text-center">
					<a href="tltd.jsp?type=tltd&fun=2&id={{news.id}}" class="btn btn-success btn-xs">详情</a>
				</td>
			</tr>
		</table>
