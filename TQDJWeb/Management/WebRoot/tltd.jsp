...
<body>
	<div class="container" ng-controller="tltdcontent">
		...
		<form class="form-horizontal">
			<div class="form-group">
				...
				<div class="col-md-10">
					<input type="text" class="form-control" id="title" placeholder="请输入两学一做标题，不能为空">
				</div>
			</div>
			<div class="form-group">
				<label for="summary" class="col-md-2 control-label">简介</label>
				<div class="col-md-10">
					<input type="text" class="form-control" id="summary" placeholder="请输入两学一做导语">
				</div>
			</div>
			<div class="form-group">
				<label for="source" class="col-md-2 control-label">来源</label>
				<div class="col-md-10">
					<input type="text" class="form-control" id="source" placeholder="请输入两学一做来源，不能为空">
				</div>
			</div>
			<div class="form-group">
				<label for="text" class="col-md-2 control-label">正文</label>
				<div class="col-md-10">
					<textarea class="form-control" id="text" rows="8" placeholder="请输入两学一做内容，不能为空"></textarea>
				</div>
			</div>
