...
public class ExamDao extends AbstractDao<Exam> implements IDao {

	private Parameters params;
	private TableData tableData;

	public ExamDao() {
		params = new Parameters(DATABASE, EXAM_TABLE);
		tableData = Jdcb.getTableData(DATABASE, EXAM_TABLE);
	}

	@Override
	public String create(Exam obj) {
	...
	public List<Map<String, String>> searchAllList() {
		CachedRowSet rowSet = DAQuery.search(params).executeSearch();
		return rowSetToList(rowSet);
	}
}
